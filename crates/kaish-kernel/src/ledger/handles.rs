...
use kaish_types::approval::{
    ApprovalAssessment, ApprovalPage, ApprovalRequest, ApprovalRequestDraft, ApprovalRequestView,
    ApprovalScope, AttemptId, AttemptState, CancelReason, Grant, GrantTerms, Grounds, LedgerCursor,
    LedgerPage, LedgerRecord, ObservedResource, OperationId, Outcome, PageRequest, Plan, Principal,
...
impl ApproverHandle {
    ...
    pub fn assessments(&self) -> AssessmentRecorder {
        AssessmentRecorder(Arc::clone(&self.0), self.2.clone())
    }
